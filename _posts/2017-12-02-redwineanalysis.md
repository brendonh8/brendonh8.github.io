...
![image-center](/assets/images/wine/preoject/unnamed-chunk-4-1.png){: .align-center}

Separating the quality into categories shows a more clear distinction between high and low quality wines.

![image-center](/assets/images/wine/preoject/unnamed-chunk-5-1.png){: .align-center}
...
![image-center](/assets/images/wine/preoject/unnamed-chunk-6-1.png){: .align-center}

Sulphates has a slightly positively skewed distribution. Using a log10 transform shows a more normal distribution.

![image-center](/assets/images/wine/preoject/unnamed-chunk-7-1.png)![image-center](/assets/images/wine/preoject/unnamed-chunk-7-2.png){: .align-center}
